...
@Component({
  ...
  template: `
    <div class="taxPeoplePickerContainer" [formGroup]="group">
		<input type="text" [attr.id]="controlId" matTooltip="Enter Employee Number" matTooltipShowDelay="1500" matTooltipPosition="above"  [formControlName]="controlKey" class="form-control taxPeoplePickerText">
