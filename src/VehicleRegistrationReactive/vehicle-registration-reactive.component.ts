...
import {SharepointListsWebService,SharePointUserProfileWebService,SharePointUserProfile,UrlService} from 'ng-tax-share-point-web-services-module';
			...
			<div *ngIf="!(idSubmitted)">
				...
				<div class="form-horizontal SpTaxFormContainer"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-8"  >
							<nested-reactive-component  controlId="TaxVehicleEmployeeNumber" controlKey="insideTextbox"  [requiredMessage]="validationMessages.EmployeeNumber.required" [group]="vehicleFormData.get('EmployeeNumber')"></nested-reactive-component>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4" for="TaxVehicleEmployeePhone" >Work Phone Number: </label>
						<div class="col-sm-8"  >
							<input type="tel" id="TaxVehicleEmployeePhone" class="form-control" [matTooltipShowDelay]="tooltipDelay" matTooltipPosition="above" matTooltip="Enter Work Phone Number"  formControlName="EmployeePhone" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-8"  >
							<input type="tel" id="TaxVehicleEmployeeEmail" class="form-control" [matTooltipShowDelay]="tooltipDelay" matTooltipPosition="above" matTooltip="Enter Email Address"  formControlName="EmployeeEmail" />
					...
					<!--div class="form-group">
						...
						<div class="col-sm-8"  >
							<nested-reactive-component matTooltip="Enter Dummy Person" controlId="TaxVehicleDummyPerson" controlKey="insideTextbox"  [requiredMessage]="validationMessages.EmployeePerson.required" [group]="vehicleFormData.get('EmployeePerson')"></nested-reactive-component>
						</div>
					</div-->
				</div>
					...
					<div class="col-sm-4">
						<div class="row SpTaxFormContainer">
							<div class="form-group">
								...
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle1Year" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Year" formControlName="Vehicle1Year" maxLength="4"/>
							...
							<div class="form-group">
								...
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle1Make" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Make" formControlName="Vehicle1Make" />
							...
							<div class="form-group">
								...
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle1Model" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Model" formControlName="Vehicle1Model" />
							...
							<div class="form-group">
								...
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle1Color" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Color" formControlName="Vehicle1Color" />
							...
							<div class="form-group">
								...
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle1LicensePlate" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter License Plate Number" formControlName="Vehicle1LicensePlate" />
					...
					<div class="col-sm-4">
						<div class="row SpTaxFormContainer">
							<div class="form-group">
								...
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle2Year" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Year" formControlName="Vehicle2Year"  maxLength="4"/>
							...
							<div class="form-group">
								...
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle2Make" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Make" formControlName="Vehicle2Make" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="TaxVehicle2Model" >Model: </label>
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle2Model" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Model" formControlName="Vehicle2Model" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="TaxVehicle2Color">Color: </label>
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle2Color" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Color" formControlName="Vehicle2Color" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="TaxVehicle2LicensePlate">License Plate Number: </label>
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle2LicensePlate" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter License Plate Number" formControlName="Vehicle2LicensePlate" />
								</div>
							</div>
						</div>		
					</div>
					<div class="col-sm-4">
						<div class="row SpTaxFormContainer">
							<div class="form-group">
								...
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle3Year" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Year" formControlName="Vehicle3Year"  maxLength="4"/>
							...
							<div class="form-group">
								...
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle3Make" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Make" formControlName="Vehicle3Make" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="TaxVehicle3Model" >Model: </label>
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle3Model" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Model" formControlName="Vehicle3Model" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="TaxVehicle3Color">Color: </label>
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle3Color" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter Color" formControlName="Vehicle3Color" />
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-4" for="TaxVehicle3LicensePlate">License Plate Number: </label>
								<div class="col-sm-8"  >
									<input type="text" id="TaxVehicle3LicensePlate" class="form-control" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Enter License Plate Number" formControlName="Vehicle3LicensePlate" />
								</div>
							</div>
						</div>		
					</div>	
				...
				<div *ngIf="vehicleFormData.get('HasHandicapPermit').value"  class="form-horizontal SpTaxFormContainer"> 
					<div class="form-group">
						...
						<div class="col-sm-8"  >
							<input  type="text" class="form-control" id="TaxVehicleHandicapPermitRegistration" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Handicap (HC) Parking Permit Registration #" formControlName= "HandicapPermitRegistration" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-4" for="TaxVehiclePlacardNumber" >Placard Number: </label>
						<div class="col-sm-8"  >
							<input type="text" class="form-control" id="TaxVehiclePlacardNumber" matTooltipPosition="above" [matTooltipShowDelay]="tooltipDelay" matTooltip="Placard Number:"  formControlName = "HandicapPlacardNumber"/>
						</div>
					</div>
				</div> 
...
export class VehicleRegistrationReactiveComponent implements OnInit {
	...
	constructor(private fb:FormBuilder, 
		...
		this.createForm();
		this.vehicleRegistrationBusiness = new VehicleRegistrationBusiness(sharepointListsWebService, sharePointUserProfileService);
	}
	...
	peoplePickedEventHandler(idAccount:string){
		...
		//we have the id account so we can set it immediately:
		this.vehicleFormData.get('EmployeeNumber.insideTextbox').patchValue(idAccount);
		
		this.vehicleRegistrationBusiness.getUserProfile(idAccount).then((userProfile)=>{
			if(userProfile.workEmail){
				this.vehicleFormData.get('EmployeeEmail').patchValue(userProfile.workEmail);
			}
			if(userProfile.workPhone){
				this.vehicleFormData.get('EmployeePhone').patchValue(userProfile.workPhone);
			}
		});
	}
